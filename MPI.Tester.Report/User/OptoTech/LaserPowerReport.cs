    ...
    partial class Report : ReportBase
    {
        ...
        public override void PushRemarkInfo(string pushStr)
        {
               ...
               this.UISetting.LaserPowerLogPath.EnablePath)
            {
                ...
                {
                    Console.WriteLine("[OptoTech.Report]PushRemarkInfo(),Exception:" + e.Message);
                    return;
                }                
            }
        ...
        private bool OpenLogFile(string str)
        {
            try
            {
                Console.WriteLine("[OptoTech.Report],OpenLogFile()");
            ...
            {
                Console.WriteLine("[OptoTech.Report]OpenLogFile(),Exception:" + e.Message);
                return false;
            }
            return true;
        ...
        private bool WriteLog(string str)
        {
            ...
            {
                Console.WriteLine("[OptoTech.Report]WriteLog(),Str:"+ str +",Exception:" + e.Message );
                return false;
            }
            return true;
        }
        ...
        private bool CloseLaserLog()
        {
            try
            {
                Console.WriteLine("[OptoTech.Report]CloseLaserLog()");
                if (_lsw != null)
                {
                    _lsw.Close();
                    _lsw.Dispose();
        ...
        {
            Console.WriteLine("[OptoTech.Report],CreateLogFileHeader()");
            ...
            {
                Console.WriteLine("[OptoTech.Report]CreateLogFileHeader(),Exception:" + e.Message);
                return false;
            }
            return true;
        }
