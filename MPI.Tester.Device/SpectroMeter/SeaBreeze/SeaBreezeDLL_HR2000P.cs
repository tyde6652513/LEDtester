...
{
    public class SeaBreezeDLL_HR2000P : ISeaBreeze
    {
        private const string DLL_PATH = @"C:\MPI\LEDTester\Driver\HR2000P.dll";

        public SeaBreezeDLL_HR2000P()
        { 
        }

        #region >>> DLL Declaration (HR2000P) <<<
