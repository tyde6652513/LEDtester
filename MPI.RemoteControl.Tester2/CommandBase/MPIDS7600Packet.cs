...
namespace MPI.RemoteControl.Tester.Mpi.Command.Base
{
    // ========================================================================================================
    //	Packet Definition
    // --------------------------------------------------------------------------------------------------------
    ...
    public class MPIDS7600Packet : IPacket, IDisposable
    {
        ...
        public uint DataLength
        {
            get
            {
                ...
                return BitConverter.ToUInt32(this._buffer, LENGTH_POS);
            }
            set
            {
                byte[] data = BitConverter.GetBytes(value);
        ...
        public void CopyFrom(MPIDS7600Packet other)
        {
            int nLength = Math.Min(other._buffer.Length, this._buffer.Length);

            Array.Copy(other._buffer, 0, this._buffer, 0, nLength);
        }
