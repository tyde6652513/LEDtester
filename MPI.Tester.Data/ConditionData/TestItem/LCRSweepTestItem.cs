...
{
	[Serializable]
	public class LCRSweepTestItem : TestItemData
	{
		private LCRSettingData _lcrSetting;

        public LCRSweepTestItem()
			: base()
        {
            this._lockObj = new object();
          
            this._type = ETestType.LCRSWEEP;
            ...
            this._msrtResult[(int)ELCRMsrtType.LCRVDC].IsEnable = true;
            ...
            this._msrtResult[(int)ELCRMsrtType.LCRIDC].IsEnable = true;
        ...
        //public LCRTestItem(int index):this()
        //{
