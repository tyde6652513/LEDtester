...
namespace MPI.Drawing.Forms
{
	public class GDIDrawPanel : Control
	{
		...
		protected override void OnHandleCreated( EventArgs e )
		{
			...
			_canvas.Background = ColorTranslator.ToWin32( base.BackColor );
		...
		public override Color BackColor
		{
			...
			{
				if ( _canvas != null )
					return ColorTranslator.FromWin32( _canvas.Background );
			...
			{
				if ( _canvas != null )
					_canvas.Background = ColorTranslator.ToWin32( value );
				else
