...
{
    public class CmdSetTestItem : RegCmdBase
    {      
        ...
        public CmdSetTestItem() : base(Convert.ToUInt16(EMeterCmdID.SetTestItem), 28, 0)
        { 
        }

        public CmdSetTestItem(int CmdID) : base(Convert.ToUInt16(CmdID), 28, 0)
        { 
        }
