...
{
    public class CmdSetCurrTestItem : RegCmdBase
    {
        ...
        public CmdSetCurrTestItem() : base(Convert.ToUInt16(EMeterCmdID.SetCurrTestItem), 28, 0)
        { 
        }

        public CmdSetCurrTestItem(int CmdID) : base(Convert.ToUInt16(CmdID), 28, 0)
        { 
        }
