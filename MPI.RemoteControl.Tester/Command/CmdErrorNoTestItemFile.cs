...
{
    /// <summary>
    /// Error : No Test Item File
    /// </summary>
    public class CmdErrorNoTestItemFile : MPIDS7600Command
    {
		public static MPIDS7600ConstDefinitionBase Const = MPIDS7600Command.ConstDefinition;

		// CommandID.
        public const Int32 COMMAND_ID = (int)ETSECommand.ID_ERROR_NO_TEST_ITEM_FIlE;
