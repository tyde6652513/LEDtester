...
{
    public partial class frmItemSettingVISWEEP : Form, IConditionUICtrl, IConditionElecCtrl
    {
        private object _lockObj;

        private VISweepTestItem _item;
        ...
        private string fUnit = "V";
        private string mUnit = "mA";
        private string tUnit = "ms";

        public frmItemSettingVISWEEP()
        {
            InitializeComponent();

            this._lockObj = new object();

            this._item = new VISweepTestItem();
        ...
        public frmItemSettingVISWEEP(TestItemDescription description)
            : this()
        {
        ...
        {
            this._item = (data as VISweepTestItem).Clone() as VISweepTestItem;
